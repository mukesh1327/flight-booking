...
public class PublicAuthController implements PublicAuthApi {
    ...
    @Override
    public ResponseEntity<AuthSessionResponse> googleCallback(String code, String state, String device, String ip) {
        return ResponseEntity.ok(service.completePublicGoogleLogin(code, state, device, ip));
    }
